...
def test_render_script_wires_all_stages(
    mock_tts, mock_duration, mock_resolve, mock_ass, mock_plan, mock_clip, mock_assemble, tmp_path
):
    ...
    # per-scene transitions are forwarded to the assembler
...
def test_render_script_routes_polaroid_layout_to_polaroid_builder(
    mock_tts, mock_duration, mock_resolve, mock_ass, mock_plan, mock_polaroid, mock_assemble, tmp_path
):
...
def test_render_script_routes_split_layout_to_split_builder(
    mock_tts, mock_duration, mock_resolve, mock_ass, mock_plan, mock_split, mock_assemble, tmp_path
):
